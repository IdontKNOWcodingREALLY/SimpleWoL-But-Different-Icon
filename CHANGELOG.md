...
## [1.3.1] - 26-06-21
### Bugfix
- Fixed automatic device discovery (network scan) not finding services on the LAN
- Fixed About screen not showing device model (was only showing IP)
- Fixed Android release build failures caused by a stale `pubspec.lock` and outdated AGP/Gradle/Kotlin versions

### Feature
- Updated all project dependencies to latest compatible versions
- Cleaned up About screen and updated all links to point to this fork's repository
